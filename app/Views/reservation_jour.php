    ...
    if (!isset($traite[$r->ress_nom])) {
        ...
        foreach ($reservations as $res) {
            if ($res->ress_nom == $ress) {
                ...
                echo "<strong><br>Heure de début :</strong> " . esc($res->res_heure_debut) . " — ";
                echo "<strong><br>Heure de fin :</strong> " . esc($res->res_heure_fin) . " — ";
                echo "<strong><br>Participants :</strong> " . esc($res->participants) . " — ";
