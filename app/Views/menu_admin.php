        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item mt-3">
                <a class="nav-link" href="<?= base_url('index.php/compte/lister') ?>">
                    ...
                    <span>Liste Compte/Profil</span>
                </a>

                <a class="nav-link" href="<?= base_url('index.php/compte/afficherlistemessage') ?>">
                    <i class="fas fa-users"></i>
                    <span>Contact</span>
                </a>
                 <a class="nav-link" href="<?= base_url('index.php/compte/affichercreneau1') ?>">
                    <i class="fas fa-users"></i>
                    <span>chercher Réservation</span>
                </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container text-center my-auto">
                    <span>Copyright © Youth Center</span>
                </div>
            </footer>
